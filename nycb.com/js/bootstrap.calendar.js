    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
                        ...
                        '<table class="calendar" id="calendar">'+
                            ...
                            '<tfoot>'+
                                '<th colspan="2" class="sel" id="last"><div class="arrow"><i class="glyphicon glyphicon-arrow-left"></i></div></th>'+
                                '<th colspan="3" class="sel" id="current">%msg_today%</th>'+
                                '<th colspan="2" class="sel" id="next"><div class="arrow"><i class="glyphicon glyphicon-arrow-right"></i></div></th>'+
                            '</tfoot>'+
                        '</table>'+
                    '',
